    ...
    return (
        <div className='flex flex-col gap-[3rem] justify-center md:px-[5rem] px-[1rem] text-gray-900'>
            <div className="flex flex-col gap-[2.8rem] text-gray-900 text-center">
                <h1 className='text-5xl font-semibold leading-[2.9rem]'>- See How Peaky Can Help -</h1>
                <p className='tracking-wide'>Discover the Power of Peaky. Unveiling How Peaky Can Simplify
